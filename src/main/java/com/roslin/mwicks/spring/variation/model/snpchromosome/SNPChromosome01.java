...
/**
 * An entity class which contains the information of a single SNPChromosome01 Table Row.
 * @author Mike Wicks
 */
@Entity
@Table(name = "VSC_SNP_CHROMOSOME_01")
@Transactional

public class SNPChromosome01 {
     ...
     */
    public boolean isSameAs(SNPChromosome01 snpchromosome){
    ...
    public boolean equals(Object other) {
        ...
        return (other instanceof SNPChromosome01) && (oid != null) 
        		? oid.equals(((SNPChromosome01) other).oid) 
        		: (other == this);
    }
    ...
    // SNPChromosome01 Builder ---------------------------------------------------------------------
    /**
     * Gets a builder which is used to create SNPChromosome01 objects.
     * 
    ...
    /**
     * A Builder class used to create new SNPChromosome01 objects.
     */
    public static class Builder {
    	
        SNPChromosome01 built;
        ...
        /**
         * Builds the new SNPChromosome01 object.
         * 
         * @return this. The created SNPChromosome01 object.
         */
        public SNPChromosome01 build() {
