...
/**
 * Declares methods used to obtain and modify SNPChromosome03 information.
 * @author Mike Wicks
 */
public interface ServiceSNPChromosome03 {
     ...
     * @throws SNPChromosome03NotFoundException  if no snpchromosome is found with the given id.
     */
     ...
     * @throws SNPChromosome03NotFoundException  if no snpchromosome is found with given id.
     */
    public SNPChromosome03 update(SNPChromosome03 updated) throws ExceptionSNPChromosomeNotFound;

    /**
     * Searches SNPChromosome03s by using the search criteria given as a parameter.
     * @param searchCriteria
     * @param pageIndex
     * @return  A Page of SNPChromosome03s matching with the search criteria. 
     ...
     * Searches SNPChromosome03s by using the search criteria given as a parameter.
     * @param searchCriteria
     * @return  A list of SNPChromosome03s matching with the search criteria. 
     *          If no SNPChromosome03s is found, this method returns an empty list.
     */
