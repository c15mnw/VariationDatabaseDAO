...
/**
 * An entity class which contains the information of a single SNPChromosome04 Table Row.
 * @author Mike Wicks
 */
@Entity
@Table(name = "VSC_SNP_CHROMOSOME_04")
@Transactional

public class SNPChromosome04 {
     ...
     */
    public boolean isSameAs(SNPChromosome04 snpchromosome){
    ...
    public boolean equals(Object other) {
        ...
        return (other instanceof SNPChromosome04) && (oid != null) 
        		? oid.equals(((SNPChromosome04) other).oid) 
        		: (other == this);
    }
    ...
    // SNPChromosome04 Builder ---------------------------------------------------------------------
    /**
     * Gets a builder which is used to create SNPChromosome04 objects.
     * 
    ...
    /**
     * A Builder class used to create new SNPChromosome04 objects.
     */
    public static class Builder {
    	
        SNPChromosome04 built;
        ...
        /**
         * Builds the new SNPChromosome04 object.
         * 
         * @return this. The created SNPChromosome04 object.
         */
        public SNPChromosome04 build() {
