...
/**
 * An entity class which contains the information of a single SNPChromosome07 Table Row.
 * @author Mike Wicks
 */
@Entity
@Table(name = "VSC_SNP_CHROMOSOME_07")
@Transactional

public class SNPChromosome07 {
     ...
     */
    public boolean isSameAs(SNPChromosome07 snpchromosome){
    ...
    public boolean equals(Object other) {
        ...
        return (other instanceof SNPChromosome07) && (oid != null) 
        		? oid.equals(((SNPChromosome07) other).oid) 
        		: (other == this);
    }
    ...
    // SNPChromosome07 Builder ---------------------------------------------------------------------
    /**
     * Gets a builder which is used to create SNPChromosome07 objects.
     * 
    ...
    /**
     * A Builder class used to create new SNPChromosome07 objects.
     */
    public static class Builder {
    	
        SNPChromosome07 built;
        ...
        /**
         * Builds the new SNPChromosome07 object.
         * 
         * @return this. The created SNPChromosome07 object.
         */
        public SNPChromosome07 build() {
