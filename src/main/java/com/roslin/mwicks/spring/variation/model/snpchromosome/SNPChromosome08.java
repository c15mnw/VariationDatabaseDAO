...
/**
 * An entity class which contains the information of a single SNPChromosome08 Table Row.
 * @author Mike Wicks
 */
@Entity
@Table(name = "VSC_SNP_CHROMOSOME_08")
@Transactional

public class SNPChromosome08 {
     ...
     */
    public boolean isSameAs(SNPChromosome08 snpchromosome){
    ...
    public boolean equals(Object other) {
        ...
        return (other instanceof SNPChromosome08) && (oid != null) 
        		? oid.equals(((SNPChromosome08) other).oid) 
        		: (other == this);
    }
    ...
    // SNPChromosome08 Builder ---------------------------------------------------------------------
    /**
     * Gets a builder which is used to create SNPChromosome08 objects.
     * 
    ...
    /**
     * A Builder class used to create new SNPChromosome08 objects.
     */
    public static class Builder {
    	
        SNPChromosome08 built;
        ...
        /**
         * Builds the new SNPChromosome08 object.
         * 
         * @return this. The created SNPChromosome08 object.
         */
        public SNPChromosome08 build() {
