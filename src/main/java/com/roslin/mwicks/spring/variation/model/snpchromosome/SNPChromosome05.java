...
/**
 * An entity class which contains the information of a single SNPChromosome05 Table Row.
 * @author Mike Wicks
 */
@Entity
@Table(name = "VSC_SNP_CHROMOSOME_05")
@Transactional

public class SNPChromosome05 {
     ...
     */
    public boolean isSameAs(SNPChromosome05 snpchromosome){
    ...
    public boolean equals(Object other) {
        ...
        return (other instanceof SNPChromosome05) && (oid != null) 
        		? oid.equals(((SNPChromosome05) other).oid) 
        		: (other == this);
    }
    ...
    // SNPChromosome05 Builder ---------------------------------------------------------------------
    /**
     * Gets a builder which is used to create SNPChromosome05 objects.
     * 
    ...
    /**
     * A Builder class used to create new SNPChromosome05 objects.
     */
    public static class Builder {
    	
        SNPChromosome05 built;
        ...
        /**
         * Builds the new SNPChromosome05 object.
         * 
         * @return this. The created SNPChromosome05 object.
         */
        public SNPChromosome05 build() {
