...
/**
 * An entity class which contains the information of a single SNPChromosome06 Table Row.
 * @author Mike Wicks
 */
@Entity
@Table(name = "VSC_SNP_CHROMOSOME_06")
@Transactional

public class SNPChromosome06 {
     ...
     */
    public boolean isSameAs(SNPChromosome06 snpchromosome){
    ...
    public boolean equals(Object other) {
        ...
        return (other instanceof SNPChromosome06) && (oid != null) 
        		? oid.equals(((SNPChromosome06) other).oid) 
        		: (other == this);
    }
    ...
    /**
     * Gets a builder which is used to create SNPChromosome06 objects.
     * 
    ...
    /**
     * A Builder class used to create new SNPChromosome06 objects.
     */
    public static class Builder {
    	
        SNPChromosome06 built;
        ...
        /**
         * Builds the new SNPChromosome06 object.
         * 
         * @return this. The created SNPChromosome06 object.
         */
        public SNPChromosome06 build() {
