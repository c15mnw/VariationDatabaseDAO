...
/**
 * An entity class which contains the information of a single SNPChromosome03 Table Row.
 * @author Mike Wicks
 */
@Entity
@Table(name = "VSC_SNP_CHROMOSOME_03")
@Transactional

public class SNPChromosome03 {
     ...
     */
    public boolean isSameAs(SNPChromosome03 snpchromosome){
    ...
    public boolean equals(Object other) {
        ...
        return (other instanceof SNPChromosome03) && (oid != null) 
        		? oid.equals(((SNPChromosome03) other).oid) 
        		: (other == this);
    }
    ...
    // SNPChromosome03 Builder ---------------------------------------------------------------------
    /**
     * Gets a builder which is used to create SNPChromosome03 objects.
     * 
    ...
    /**
     * A Builder class used to create new SNPChromosome03 objects.
     */
    public static class Builder {
    	
        SNPChromosome03 built;
        ...
        /**
         * Builds the new SNPChromosome03 object.
         * 
         * @return this. The created SNPChromosome03 object.
         */
        public SNPChromosome03 build() {
